...
DECISIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "source_support": "BLS CE 2024 Interview PUMD (intrvw24.zip) retrieved and FMLI parsed.",
        "sensitivity_plan": "P20/P25/P30 on vehicle-maintenance/tires UCC codes after dictionary freeze.",
    },
    {
        "id": "OD-008",
    ...
    {
        "id": "OD-013",
        "question": "How should Connecticut ACS planning regions be joined to HUD county FMR rows?",
        "why_it_matters": "2024 ACS 5-Year uses Connecticut planning-region FIPS (09110-09170). HUD FMR still publishes legacy county FIPS. Nine ACS geographies (about 2.9 million adults) currently unmatched.",
        "option_a": "Build an official CT OPM/Census crosswalk from planning regions to legacy counties and allocate FMR.",
        "option_b": "Leave CT unmatched until HUD publishes planning-region FMR.",
